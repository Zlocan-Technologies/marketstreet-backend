...
class DashboardHomeController extends Controller
{
    ...
    public function __construct(DashboardService $dashboardService){
        ...
        $this->data =  [
            ...
            'pendingOrders'      =>  $dashboardService->paginate($this->pending, 10),
            'activeOrders'       =>  $dashboardService->paginate($this->activeOrders, 10),
            'deliveredOrders'    =>  $dashboardService->paginate($this->deliveredOrders, 10),
            'confirmedOrders'    =>  $dashboardService->paginate($this->confirmedOrders, 10),
            'pendingPayments'    =>  $dashboardService->paginate($this->pendingPayments, 10),
        ];
    }
    ...
    public function users(Request $request){
        ...
        if($request->has('search_query')){
            ...
            $users = User::where('isBlocked', false)->latest()->paginate(4);
        }
    ...
    public function blockedUsers(Request $request){
        ...
        if($request->has('search_query')){
            ...
            $users = User::where('isBlocked', true)->latest()->paginate(4);
        }
    ...
    public function OrderReport(Request $request){
        $from = $request->has('from') ? Carbon::parse($request->from) : Carbon::parse('2022-11-28');
        ...
        $orderReports = DashboardService::paginate($m4, 20); 
    ...
    public function payments(Request $request){
        ...
        $paymentReports = DashboardService::paginate($pendingOrders, 40);
