<div class="container d-flex justify-content-center align-items-center pt-4">
    ...
    <div class="mx-auto">
        ...
        <form onsubmit="updateCoupon(event)" id="couponForm" class="category-form px-4 py-3">
            @csrf
        <div class="title-header  d-flex justify-content-between align-items-center px-3 py-3">
            <h3 class="px-2 pl-0">Edit Coupon</h3>
         ...
         <div class="row w-100">
            <div class="form-group col-lg-6 col-sm-12 my-4">
                ...
                <input type="text" value="{{ $coupon->code }}" required name="coupon_code" id="coupon_code" class="form-control">
             ...
             <div class="form-group col-lg-6 col-sm-12 my-4">
                ...
                <input type="text" value="{{ $coupon->type }}" name="coupon_type" id="coupon_type" class="form-control">
            </div>
            <div class="form-group col-lg-6 col-sm-12 my-4">
                <label for="name">Value</label>
                <input type="number" value="{{ $coupon->value }}" name="coupon_value" id="coupon_value" class="form-control">
            </div>
            <div class="form-group col-lg-6 col-sm-12 my-4">
                <label for="name">Percent Off <b>(%)</b></label>
                <input type="text" value="{{ $coupon->percent_off }}" name="percent_off" id="coupon_percent_off" class="form-control">
            </div>
         </div>
         <div class="row">
            <button onclick="updateCoupon(event)" id="coupon-btn" type="submit" class="bg-info border-0 btn-lg btn-flat">Submit</button>
         </div>
        </form>
    </div>
</div>
