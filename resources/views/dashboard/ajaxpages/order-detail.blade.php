<div class="container-fluid bg-white">
    ...
    <div class="row d-flex justify-content-between align-items-center pt-3">
        ...
        <div class="col-6 d-flex justify-content-end">
             <select onchange="confirmOrder(event, {{ $order->id}}, this.value)" name="order_status" style="width: 300px; max-width: 100%;" id="order_status" class="form-control border border-sm border-info text-info">
    ...
    <div class="row d-flex justify-content-between align-items-start my-5 p-2">
        ...
        <div class="col-lg-8 p-3">
            ...
            <div class="card">
                  <div class="row card-body d-flex align-items-center ">
                    <h4 class="py-3">Account Information </h4>
                    <div class="col-lg-4 col-6 mb-4">
                       <p class="w-100 text-secondary">Account Name</p>
                        <p class="mb-0">
                            {{ $order->user->bankDetail->account_name }}
                        </p> 
                    </div>

                    <div class="col-lg-4 col-6 mb-4">
                       <p class="w-100 text-secondary">Account Number</p>
                        <p class="mb-0">
                            {{ $order->user->bankDetail->account_number  }}
                        </p> 
                    </div>

                    <div class="col-lg-4 col-6 mb-4">
                       <p class="w-100 text-secondary">Bank Name</p>
                        <p class="mb-0">
                            {{ $order->user->bankDetail->bank_name  }}
                        </p> 
                    </div>
