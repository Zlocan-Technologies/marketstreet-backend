            ...
            <div class="row d-flex justify-content-between align-items-center">
              ...
              <div class="col-sm-12 col-md-6 col-xl-6 mt-4">
                <div class="card height-equal shadow-lg">
                  ...
                  <div class="card-footer py-0" style="max-width: 100%;">
                    <div
                    ...
                    <div
                        class="w-100 mb-3 d-flex justify-content-between align-items-center"
                      >
                        <button onclick="confirmOrder(event, {{ $order->id}}, 'shipped')" class="btn-info border-0 btn-md ml-2 px-4 py-2">
                          Ship <i class="fa fa-truck"></i>
                        </button>
                      </div>
                  </div>
                </div>
                ...
                <div class="card height-equal shadow-lg">
                  ...
                  <div class="card-footer py-0">
                    ...
                    <div
                        class="w-100 mb-3 d-flex justify-content-between align-items-center"
                      >
                        <button onclick="confirmOrder(event, {{ $order->id}}), 'confirmed'" class="btn-info border-0 btn-md ml-2 px-4 py-2">
                  ...
                  <div class="card height-equal shadow-lg">
                    ...
                    <div class="card-footer py-0">
                      ...
                      <div
                          class="w-100 mb-3 d-flex justify-content-between align-items-center"
                        >
                          <button onclick="confirmOrder(event, {{ $order->id}}, 'paid')" class="btn-info border-0 btn-md ml-2 px-4 py-2">
