                    ...
                    <table class="table table-border-horizontal">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>&#x20a6;{{ $order->total }}</td>
                          <td>
                            <select onchange="confirmOrder(event, {{ $order->id}}, this.value)" name="order_status" style="width: 100%; max-width: 100px;" id="order_status" class="form-control border border-sm border-info text-info">
                     ...
                     <!--Pagination Links-->
                      <div div="row">
                          <ul class="pagination pagination-primary justify-content-start">
                              <li>{{ $orderReports->links("pagination::bootstrap-4") }}</li>
                          </ul>   
                      </div>
