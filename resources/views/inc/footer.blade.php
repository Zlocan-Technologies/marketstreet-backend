		...
		<div class="auto-container">
                            ...
                            <div class="footer-column col-lg-7 col-md-6 col-sm-12">
                                <div class="footer-widget logo-widget">
									...
									<ul class="contact-list">
										<li><a href="mailto:oswo@gmail.com">oswo@gmail.com</a></li>
										<li><a href="tel:+000-999-0000">+000-999-0000</a></li>
									</ul>
								</div>
							</div>
			...
			<div class="footer-bottom">
				<div class="clearfix">
					...
					<div class="pull-left">
						<div class="copyright">&copy; 2020 Oswo. All rights reserved</div>
					</div>
