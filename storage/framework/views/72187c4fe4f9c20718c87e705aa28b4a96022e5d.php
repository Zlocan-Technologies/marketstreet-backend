...
<section class="banner-section">
		<div class="patern-layer-one" style="background-image: url(<?php echo e(asset('assets/landing/images/background/1.png')); ?>)"></div>
		<div class="patern-layer-two" style="background-image: url(<?php echo e(asset('assets/landing/images/background/pattern-1.png')); ?>)"></div>
		<!-- <div class="patern-layer-three" style="background-image: url(<?php echo e(asset('assets/landing/images/background/pattern-2.png')); ?>)"></div>
		<div class="patern-layer-four" style="background-image: url(<?php echo e(asset('assets/landing/images/background/pattern-3.png')); ?>)"></div> -->
		<div class="patern-layer-five" style="background-image: url(<?php echo e(asset('assets/landing/images/background/pattern-4.png')); ?>)"></div>
		<div class="patern-layer-six" style="background-image: url(<?php echo e(asset('assets/landing/images/background/pattern-5.png')); ?>)"></div>
		<div class="patern-layer-seven" style="background-image: url(<?php echo e(asset('assets/landing/images/background/pattern-6.png')); ?>)"></div>
		<div class="patern-layer-eight" style="background-image: url(<?php echo e(asset('assets/landing/images/background/pattern-7.png')); ?>)"></div>
		<div class="patern-layer-nine" style="background-image: url(<?php echo e(asset('assets/landing/images/background/pattern-8.png')); ?>)"></div>
						...
						<div class="image-column col-lg-6 col-md-12 col-sm-12">
							<div class="inner-column parallax-scene-1">
								<div class="image" data-depth="0.10">
									<img src="<?php echo e(asset('assets/landing/images/resource/aaxa.png')); ?>" alt="" />
								</div>
								<div class="image-two" data-depth="0.10">
									<!-- <img src="<?php echo e(asset('assets/landing/images/resource/mobile-2.png')); ?>" alt="" /> -->
								</div>
							</div>
						</div>
    ...
    <section class="featured-section" id="services">
		<div class="icon-one" style="background-image: url(<?php echo e(asset('assets/landing/images/icons/icon-1.png')); ?>)"></div>
		<div class="icon-two" style="background-image: url(<?php echo e(asset('assets/landing/images/icons/icon-2.png')); ?>)"></div>
		<div class="auto-container">
			<!-- Sec Title -->
    ...
    <section class="email-section">
		<div class="icon-layer-one" style="background-image: url(<?php echo e(asset('assets/landing/images/background/pattern-4.png')); ?>)"></div>
		<div class="icon-layer-two" style="background-image: url(<?php echo e(asset('assets/landing/images/icons/icon-3.png')); ?>)"></div>
		<div class="auto-container">
			<div class="row clearfix">
				...
				<div class="images-column col-lg-7 col-md-12 col-sm-12">
					<div class="inner-column">
						<div class="small-image">
							<img src="<?php echo e(asset('assets/landing/images/resource/email-1.png')); ?>" alt="" />
						</div>
						<div class="image titlt" data-tilt data-tilt-max="8">
							<img src="<?php echo e(asset('assets/landing/images/resource/email.png')); ?>" alt="" />
						</div>
					</div>
				</div>
    ...
    <section class="app-section">
		<div class="icon-layer-one" style="background-image: url(<?php echo e(asset('assets/landing/images/icons/icon-4.png')); ?>)"></div>
		<div class="icon-layer-two" style="background-image: url(<?php echo e(asset('assets/landing/images/icons/icon-5.png')); ?>)"></div>
		<div class="icon-layer-three" style="background-image: url(<?php echo e(asset('assets/landing/images/background/pattern-10.png')); ?>)"></div>
		<div class="auto-container">
			<div class="row clearfix">
				...
				<div class="images-column col-lg-7 col-md-12 col-sm-12">
					<div class="inner-column">
						<div class="image titlt" data-tilt data-tilt-max="8">
							<img src="<?php echo e(asset('assets/landing/images/resource/app-1.png')); ?>" alt="" />
						</div>
						<div class="small-image titlt" data-tilt data-tilt-max="8">
							<img src="<?php echo e(asset('assets/landing/images/resource/app-2.png')); ?>" alt="" />
						</div>
					</div>
				</div>
				...
				<div class="content-column col-lg-5 col-md-12 col-sm-12">
					<div class="inner-column">
						...
						<div class="btns-box">
							<a class="theme-btn" href="#"><img src="<?php echo e(asset('assets/landing/images/icons/app.png')); ?>" alt="" /></a>
							<a class="theme-btn" href="#"><img src="<?php echo e(asset('assets/landing/images/icons/google.png')); ?>" alt="" /></a>
						</div>
	...
	<!-- Video Section -->
	<section class="video-section" style="background-image: url(<?php echo e(asset('assets/landing/images/background/2.jpg')); ?>)">
		<div class="auto-container">
    ...
    <section class="testimonial-section">
		<div class="icon-one" style="background-image: url(<?php echo e(asset('assets/landing/images/icons/icon-6.png')); ?>)"></div>
		<div class="icon-two" style="background-image: url(<?php echo e(asset('assets/landing/icons/icon-3.png')); ?>)"></div>
		<div class="icon-three" style="background-image: url(<?php echo e(asset('assets/landing/icons/icon-1.png')); ?>)"></div>
		<div class="auto-container">
			<div class="sec-title centered">
			...
			<div class="three-item-carousel owl-carousel owl-theme">
					...
					<div class="inner-box">
						...
						<div class="lower-content">
							<div class="author-image">
								<img src="<?php echo e(asset('assets/landing/images/resource/author-1.jpg')); ?>" alt="" />
							</div>
				...
				<div class="testimonial-block">
					<div class="inner-box">
						...
						<div class="lower-content">
							<div class="author-image">
								<img src="<?php echo e(asset('assets/landing/images/resource/author-2.jpg')); ?>" alt="" />
							</div>
				...
				<div class="testimonial-block">
					<div class="inner-box">
						...
						<div class="lower-content">
							<div class="author-image">
								<img src="<?php echo e(asset('assets/landing/images/resource/author-3.jpg')); ?>" alt="" />
							</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/obinnajeze/Documents/GitHub/marketstreet-backend/resources/views/welcome.blade.php ENDPATH**/ ?>